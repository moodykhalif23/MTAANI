...
function generateSecurityTokens() {
  return {
    ...
    INTERNAL_API_KEY: generateSecureSecret(32),
    ADMIN_API_KEY: generateSecureSecret(32)
  }
}
...
const environments = {
  ...
  production: {
    ...
    NEXT_PUBLIC_API_URL: 'https://mtaani.com/api',
    NEXT_PUBLIC_APP_NAME: 'Mtaani',
...
function generateEnvFile(environment = 'development') {
  ...
  const groups = {
    'APPLICATION SETTINGS': ['NODE_ENV', 'NEXT_PUBLIC_APP_URL', 'NEXT_PUBLIC_API_URL', 'NEXT_PUBLIC_APP_NAME'],
    ...
    'SECURITY CONFIGURATION': ['SECURITY_VALIDATION_TOKEN', 'INTERNAL_API_KEY', 'ADMIN_API_KEY', 'ADMIN_DASHBOARD_TOKEN', 'ADMIN_RESET_TOKEN', 'BCRYPT_SALT_ROUNDS', 'RATE_LIMIT_ENABLED', 'RATE_LIMIT_WINDOW_MS', 'RATE_LIMIT_MAX_REQUESTS'],
